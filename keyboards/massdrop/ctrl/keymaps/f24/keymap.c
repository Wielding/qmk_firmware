...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT(
        ...
        _______, LCAS_1, LCAS_2, LCAS_3, LCAS_4, LCAS_5, LCAS_6, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
...
const uint8_t PROGMEM ledmap[][DRIVER_LED_TOTAL][3] = {
 ...
 [1] = {
        _______, _______, _______, _______, _______, _______, _______,   _______, _______, _______,   _______, _______,  _______,           _______,    _______,   _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,   _______,   _______,   _______,   _______, PURPLE,    _______,   _______,
        _______, _______, _______, _______, _______, _______, _______, _______,   _______,   _______, _______, _______, _______, _______, AZURE,    AZURE,   _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______,   _______,   _______, _______, _______, _______, _______,                              _______,
        _______, _______, _______,                   _______,                            _______, _______,    _______, _______,            _______, _______, _______
    }, [2] = {
        _______, ACTIVE,   ACTIVE,   ACTIVE, ACTIVE, ACTIVE,   ACTIVE,   ACTIVE, ACTIVE, ACTIVE,   ACTIVE, ACTIVE,  ACTIVE,           _______,    _______,   _______,
        _______, ACTIVE, ACTIVE,    ACTIVE,    ACTIVE,    ACTIVE,    ACTIVE, _______, _______, _______,   _______,   _______,   _______,   _______, _______,    _______,   _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______, _______,   _______,   _______, _______, _______, _______, _______, _______,    _______,   _______,
        _______, _______,  _______,  _______,  _______,  _______,  _______, _______, _______, _______, _______, _______, _______,
        _______, _______,  _______, _______,   _______, _______,   _______,   _______, _______, _______, _______, _______,                              _______,
        _______, _______, _______,                   _______,                            _______, _______,    _______, _______,            _______, _______, _______
